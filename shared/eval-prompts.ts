...
// Used in ./03_agent_evaluation/llm.eval.ts
export const RESPONSE_CRITERIA_SYSTEM_PROMPT = `You are evaluating an email assistant that works on behalf of a user.
...
// Used in
export const HITL_FEEDBACK_SYSTEM_PROMPT = `You are evaluating an email assistant's response to determine if it meets specific criteria.
...
// Used in
export const MEMORY_UPDATE_SYSTEM_PROMPT = `This is an email assistant that uses memory to update its response preferences.
